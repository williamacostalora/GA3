...
ggplot(scaled_artist, aes(x = variable, y = value)) +
  geom_boxplot() +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(title = "Boxplots of Scaled Predictors",
       x = "Predictors",
...
Georgia also ran PCA and Clustering code for confirmation, she also helped write the Conclusion.
