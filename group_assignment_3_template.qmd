...
# Research Goals
We are Glee Cast fans who host a weekly show at the WMCN radio station. Before approving our programming, our manager asked for a review of how successful these tracks have been at the station. Our goal is to summarize and take a closer look at the station hits, audience responses, and identify any song features that might help drive popularity.
...
Since our goal is exploration, we use an unsupervised learning approach. Therefore we do not set a determined outcome ‘y’ but rather we try to take a look at the internal structure to understand the patterns. 
